...
from data_processing import fetch_training_data, create_features, calculate_target

# Model architecture for server scoring (single score per server)
class ServerScorer(nn.Module):
    def __init__(self, input_size):
        ...
        self.network = nn.Sequential(
            ...
            nn.Linear(256, 128),
            nn.ReLU(),
            nn.Linear(128, 1)  # Output single score
        )
...
# Save scaler configuration as JSON
...
if __name__ == "__main__":
    # Load and prepare data using the data_processing module
    ...
    # Export scaler and model to ONNX
    save_scaler(scaler)
